...
public class VelocityExcelMemory : ExcelBuilderMemory<VelocityExcelResponseDto>
{
    public override VelocityExcelResponseDto ExecuteExcelReaderMemory(MemoryStream file)
    {
