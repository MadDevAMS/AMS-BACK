...
public class AccelarationExcelMemory : ExcelBuilderMemory<AccelerationExcelResponseDto>
{
    public override AccelerationExcelResponseDto ExecuteExcelReaderMemory(MemoryStream file)
    {
