namespace AMS.Infrastructure.Commons.Commons
{
    ...
    internal static class ExcelResources
    {
        public const string TIMESTAMP = "timestamp";
        public const string VALUE = "value";
        public const string MEASUREMENT_TYPE = "measurement_type";
        public const string AXIS = "axis";
        public const string AXIS_LABEL = "axis_label";
        public const string SPOT_ID = "spot_id";
        ...
        public const string BATTERY_LEVEL = "battery_level";
        public const string TELEMETRY_INTERVAL = "telemetry_interval";
        ...
        public const string WORKSHEET_ERROR = "NO SE PUEDE LEER LA PRIMERA HOJA DEL ARCHIVO";
        public const string HEADERS_ERROR = "NO SE ENCONTRARON LAS CABECERAS DESEADAS";
